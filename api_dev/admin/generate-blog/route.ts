...
Please return a valid JSON object with the following structure:
{
  ...
  "content": "The full blog content in HTML format, structured with <h2>, <h3>, <p>, <ul>, <li>, <strong>, <em>, <hr>, etc. CRITICAL: You MUST use HTML tags for all headings, lists, bold text, italics, and structure. Do NOT use any Markdown formatting (like ##, #, **, *, _, etc.) inside this string. It must be pure, clean HTML.",
