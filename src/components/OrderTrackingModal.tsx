        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Order #{orderDisplayNumber || order?.id}</p>
            </div>
          </div>
          <button
            onClick={onClose}
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className={`font-medium ${
                      (order?.paymentMethod?.toLowerCase() === 'cod' || order?.payment_method?.toLowerCase() === 'cod') && order?.status !== 'completed'
                        ? 'text-amber-600'
                        : 'text-green-600'
                    }`}>
                      {(order?.paymentMethod?.toLowerCase() === 'cod' || order?.payment_method?.toLowerCase() === 'cod')
                        ? (order?.status === 'completed' ? 'Paid' : 'Cash on Delivery')
                        : 'Paid'}
                    </p>
                  </div>
                </div>
