    ...
    <div className="space-y-3">
      ...
      {step === 'phone' && (
        <form onSubmit={handleSendOTP} className="space-y-3">
          ...
          {error && (
            <div className="rounded-md p-3 border bg-red-50 border-red-200">
      ...
      {step === 'otp' && (
        <div className="space-y-3">
          {/* Success message */}
          {successMessage && (
            <div className="rounded-md p-3 border bg-green-50 border-green-200 flex items-start space-x-2">
