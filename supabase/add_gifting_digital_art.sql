-- SQL Script to insert the "Gifting digital art" blog post
...
values (
  'Gifting digital art: why a print beats anything this festive season',
  'gifting-digital-art-india',
  'Looking for a unique gift? A digital art print from Lurevi is personal, lasting and beautifully packaged.',
  '<h1>Gifting digital art in India</h1>
...
<p>Know a Messi fan? Gift our popular *Lionel Messi Beneath the Red Sun* or *Golden Football Portrait of Messi*. These dynamic illustrations elevate fan art into high-end gallery pieces.</p>

<h3>5. Tech Humor &amp; Coding Prints (For the Office or Dev Friend)</h3>
<p>For your programmer or tech-entrepreneur friends, prints like *Light Attracts Bugs* combine clean typography with witty coding humor, perfect for styling a home office desk or study wall.</p>
...
<div class="cta-container" style="text-align: center; margin: 3rem 0; padding: 2rem; background-color: #fafafa; border-radius: 12px; border: 1px solid #eaeaea;">
  ...
  'published',
  array['digital artwork', 'digital art prints', 'gifting art', 'wall art gifts', 'festive gifts India'],
  'Gifting digital art in India | Lurevi Blog',
  'Looking for a unique gift? A digital art print from Lurevi is personal, lasting and beautifully packaged.',
  now(),
